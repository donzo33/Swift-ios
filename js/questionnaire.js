...
function showEnd() {
   ...
   jQuery('<div/>', { // Le div du texte de la question
      id: 'question-fin-text',
      class: 'question-text'
   }).appendTo(path);
   $(".question-text", path).append("<p>Bravo vous avez terminé le questionnaire avec " + getOccurencesNumber(studentResult, 'right') + " bonnes réponses !</p>");
...
function getOccurencesNumber(arr, occ) {
   let n = 0;
